defmodule FoxWeb.Button do
  ...
  def button(assigns) do
    assigns = assign(assigns, :variant_class, button_variants(assigns))

    ~H"""
    <button type={@type} class={classes([@variant_class, @class])} {@rest}>
  ...
  def button_variants(props \\ %{}) do
    ...
    variant_class = Enum.map_join(variants, " ", fn {key, value} -> @variants[key][value] end)
